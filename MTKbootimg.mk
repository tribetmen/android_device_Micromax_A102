...
$(INSTALLED_RAMDISK_TARGET): $(MKBOOTFS) $(INTERNAL_RAMDISK_FILES) | $(MINIGZIP)
	...
	cmp -s device/Micromax/A102/rootdir/custom_init out/target/product/A102/root/init; \
	RETVAL=$$?; \
	if [ $$RETVAL -eq 1 ]; then \
		mv out/target/product/A102/root/init out/target/product/A102/root/init2; \
		cp device/Micromax/A102/rootdir/custom_init out/target/product/A102/root/init; \
	fi
